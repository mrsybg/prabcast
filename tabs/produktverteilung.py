...
def display_tab():
    ...
    with st.container(border=True):
        ...
        selected_products_pie = st.multiselect("Wähle Produkte für die Produktverteilung:", st.session_state.selected_products_in_data,
                                               default = st.session_state.selected_products_in_data)
